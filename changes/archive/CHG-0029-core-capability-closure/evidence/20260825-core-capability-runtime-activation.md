...
## Archived test clean-checkout follow-up

```text
FOLLOWUP_BLOCKER=ARCHIVED_CHG0029_TEST_ASSUMED_CHANGES_ACTIVE_DIRECTORY_EXISTS
FOLLOWUP_FIX=ABSENT_CHANGES_ACTIVE_DIRECTORY_COUNTS_AS_ZERO_ACTIVE_CHANGES
